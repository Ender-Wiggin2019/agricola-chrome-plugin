...
export function CardResult({ card, authors, index = 0 }: CardResultProps) {
	...
	const hasTranslation = !!(
		card.enDesc_trans2zh && card.enDesc_trans2zh.trim() !== ""
	);
	const showSwitch =
		isZh && hasTranslation && card.enDesc && card.enDesc.trim() !== "";
		...
		>
			<CardContent className="pt-6">
				...
				<div className="space-y-4 pt-4">
					...
					{/* EN Desc */}
					{((isZh && (card.enDesc_trans2zh || card.enDesc)) ||
						(!isZh && card.enDesc)) && (
						<div className="group">
