  ...
  return (
    <div className="bg-secondary/30 rounded-lg p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-xs font-semibold text-primary/80 uppercase tracking-wide">{t('stats.title')}</span>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        {stats.adp !== undefined && (
          <div className="text-center">
            ...
            <div className="font-bold" style={{ color: adpColor }}>{stats.adp.toFixed(2)}</div>
          </div>
        )}
        ...
        {stats.drawPlayRate !== undefined && (
          <div className="text-center">
            ...
            <div className="font-bold" style={{ color: drawPlayRateColor }}>{drawPlayRatePercent}%</div>
          </div>
        )}
      </div>
    </div>
