...
function TierBadge({
  ...
  return (
    <div
      ...
      title={author?.name}>
      <span className="plasmo-opacity-70 plasmo-mr-1 plasmo-text-[9px] plasmo-uppercase">
        {label}
      </span>
      {tier}
    </div>
    ...
    <div className="plasmo-bg-white plasmo-rounded-lg plasmo-border plasmo-border-gray-200 plasmo-shadow-sm plasmo-overflow-hidden">
      ...
      <div
        ...
        <div className="plasmo-flex plasmo-items-baseline plasmo-gap-2 plasmo-mb-2">
          ...
          {getCardName(card, "zh") && (
            <span className="plasmo-text-sm plasmo-font-semibold plasmo-text-gray-900">
              {getCardName(card, "zh")}
            </span>
          )}
          {getCardName(card, "en") && (
            <span className="plasmo-text-xs plasmo-text-gray-500 plasmo-italic">
              {getCardName(card, "en")}
            </span>
          )}
        </div>
        ...
        {isExpanded && (
          <div className="plasmo-px-3 plasmo-pb-3 plasmo-border-t plasmo-border-gray-100 plasmo-pt-3 plasmo-space-y-3">
            ...
            {getCardDesc(card, currentLang) && (
              <div>
                <div className="plasmo-text-[10px] plasmo-text-gray-400 plasmo-uppercase plasmo-mb-1">
                  {t("card_effect")}
                </div>
                <p className="plasmo-text-xs plasmo-text-gray-600 plasmo-leading-relaxed">
                  {getCardDesc(card, currentLang)}
                </p>
              </div>
            )}
            ...
            {authorIds.map((authorId) => {
              ...
              return (
                <div
                  key={authorId}
                  className="plasmo-bg-gray-50 plasmo-rounded plasmo-p-2">
                  <div className="plasmo-flex plasmo-items-center plasmo-gap-1.5 plasmo-mb-1">
                    {authorData?.avatar && (
                      <img
                        src={authorData.avatar}
                        alt=""
                        className="plasmo-w-4 plasmo-h-4 plasmo-rounded-full"
                      />
                    )}
              ...
              <div className="plasmo-bg-green-50 plasmo-rounded plasmo-p-2">
                ...
                <div className="plasmo-grid plasmo-grid-cols-2 plasmo-gap-2 plasmo-text-center">
                  {statsData.pwr !== undefined && (
                    <div>
                      <div className="plasmo-text-[9px] plasmo-text-gray-500">
                        {t("stats_pwr")}
                      </div>
                      <div className="plasmo-text-sm plasmo-font-bold plasmo-text-gray-900">
                        {statsData.pwr.toFixed(2)}
                      </div>
                    </div>
                  )}
                  {statsData.adp !== undefined && (
                    <div>
                      ...
                      <div
                        className="plasmo-text-sm plasmo-font-bold"
                        style={{ color: getAdpColor(statsData.adp) }}>
                  ...
                  {statsData.drawPlayRate !== undefined && (
                    <div>
                      ...
                      <div
                        className="plasmo-text-sm plasmo-font-bold"
                        style={{
                          color: getDrawPlayRateColor(statsData.drawPlayRate)
                        }}>
    ...
    <div className="plasmo-min-h-screen plasmo-bg-gradient-to-b plasmo-from-amber-50 plasmo-to-green-50">
      ...
      <div className="plasmo-sticky plasmo-top-0 plasmo-z-10 plasmo-bg-gradient-to-b plasmo-from-amber-50 plasmo-to-amber-50/95 plasmo-backdrop-blur-sm plasmo-border-b plasmo-border-amber-200/50 plasmo-px-4 plasmo-py-3">
        <div className="plasmo-flex plasmo-items-center plasmo-justify-center plasmo-gap-2 plasmo-mb-3">
          ...
          <h1 className="plasmo-text-base plasmo-font-semibold plasmo-text-green-800">
            {t("header_title")}
          </h1>
        ...
        {!isLoading && searchQuery.trim() === "" && (
          <p className="plasmo-text-[10px] plasmo-text-center plasmo-text-gray-500 plasmo-mt-2">
            <span className="plasmo-font-semibold plasmo-text-green-700">
              {cardsData.length}
            </span>{" "}
            cards
          </p>
