...
export function StatsDetails({ stats }: StatsDetailsProps) {
  ...
  return (
    <div className="plasmo-rounded-lg plasmo-p-3" style={{ backgroundColor: "#F6F6F2" }}>
      ...
      <div className="plasmo-grid plasmo-grid-cols-2 plasmo-gap-2 plasmo-text-center">
        {stats.pwr !== undefined && (
          <div>
            <div className="plasmo-flex plasmo-items-center plasmo-justify-center plasmo-gap-1 plasmo-mb-0.5">
              <span className="plasmo-text-[10px] plasmo-text-gray-500">{t("stats_pwr")}</span>
        ...
        {stats.adp !== undefined && (
          <div>
            <div className="plasmo-flex plasmo-items-center plasmo-justify-center plasmo-gap-1 plasmo-mb-0.5">
              <span className="plasmo-text-[10px] plasmo-text-gray-500">{t("stats_adp")}</span>
        ...
        {stats.apr !== undefined && (
          <div>
            <div className="plasmo-flex plasmo-items-center plasmo-justify-center plasmo-gap-1 plasmo-mb-0.5">
              <span className="plasmo-text-[10px] plasmo-text-gray-500">{t("stats_apr")}</span>
        ...
        {stats.drawPlayRate !== undefined && (
          <div>
            <div className="plasmo-flex plasmo-items-center plasmo-justify-center plasmo-gap-1 plasmo-mb-0.5">
              <span className="plasmo-text-[10px] plasmo-text-gray-500">{t("stats_playRate")}</span>
